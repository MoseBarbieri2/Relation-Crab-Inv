...
\\
A supporto del giocatore sarà presente uno scudo planetario. Per "scudo planetario" si intende uno scudo energetico ad una via: ovvero che assorbe i colpi provenienti dall'esterno e lascia passare quelli provenienti dal pianeta, di ispirazione agli scudi energetici presenti in Star Wars\footnote{\url{https://youtu.be/8oBEzKm9grM?si=BCL6keqTVwP7vrGb&t=15}}. Esattamente come gli scudi qui mostrati essi possono però essere attraversati. Il giocatore se intende sfruttare al meglio il suo supporto nella difesa del pianeta, dovrà quindi cercare di evitare che i nemici danneggino lo scudo al punto di distruggerlo o che essi riescano ad attraversarlo.
\\
...
\subsubsection{Gestione della musica}
