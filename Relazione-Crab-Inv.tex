...
del videogioco originale "Space Invaders"\footnote{\url{https://it.wikipedia.org/wiki/Space_Invaders}} 
...
La condizione di vittoria per poter passare al livello successivo (ed eventualmente "vincere il gioco") è quella di eliminare tutte le entità ostili prima che raggiungano la Terra, pena la perdità di una vita.
%
...
Il carro armato dovrà fronteggiare i "granchi alieni", che continueranno ad avvicinarsi alla Terra ad ondate, sparndogli col suo cannone e schivando i colpi alieni a lui rivolti. 
%
La Terra è dotata di uno scudo planetario che la proteggerà fino a che non verrà distrutto. Per "scudo planetario" si intende uno scudo energetico ad una via: ovvero che assorbe i colpi provenienti dall'esterno e lascia passare quelli provienti dal pianeta. I nemici caduti rilasceranno una valuta che verrà poi utilizzata per acquistare potenziamenti per il carro armato o lo scudo planetario. Col susseguirsi delle ondate si dovrebbe incontrare una difficoltà tale da perdere se non si hanno sufficienti potenziamenti. 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{img/modelloDominio.png}
