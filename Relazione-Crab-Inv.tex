...
Il gruppo si propone di creare un videogioco chiamato "Crab Invaders" ovvero una versione rivisitata in chiave rogue-lite: ovvero dove il giocatore quando muore o fallisce, può spendere la valuta data dai nemici per acquistare dei potenziamenti che permetteranno di potenziarsi ad ogni tentativo.  
%
Prendendo spunto dal videogioco originale ``"Space Invaders" del 1978''\footnote{\url{https://it.wikipedia.org/wiki/Space_Invaders}}.

\section{Descrizione e requisiti}

Il software dovrà permettere di utilizzare e manovrare in due direzioni possibili (destra e sinistra) il carro-armato, ovvero un carro armato che verrà controllato dal giocatore che potrà anche decidere quando sparare ai grachi alieni. 
%
I granchi alieni sono i nemici presenti all'interno del gioco che caleranno sul carro armato dal cielo (dall'alto dello schermo) e che cambieranno ed evolveranno nel corso di una partita. 
%
Il gioco inizia dal menu dove si comincia un salvataggio che parte con il primo livello e poi a seguire gli altri e alla fine se si riesce ad arrivare all'ultimo si finisce il gioco, ma se se si muore durante il salvataggio i nemici rilasceranno alla morte una valuta che sarà utilizzata all'interno dello shop.

\subsection*{Requisiti funzionali}
\begin{itemize}
	\item Ci dovrà essere un Menu, che parte appena parte il software con la possibilità di : \begin{itemize}
	    \item fare una nuova partita ( che cancella una evntualmente già esistente)
        \item caricare una partita non finita
        \item usare lo shop
        \item uscire dal gioco
        \item campiare le impostazioni: \begin{itemize}
        \item il volume
        \item la lingua: (italiano o inglese)
        \end{itemize}
	\end{itemize}
	\item I nemici dovranno essere divisi ad ondate all'interno dei livelli, e dovranno essere capaci di moversi e sparare contro il giocatore.
\end{itemize}

\subsection*{Requisiti non funzionali}
\begin{itemize}
	\item Che il software abbia una gestione delle risorse che abbia scarsi requisiti hardware
\end{itemize}
